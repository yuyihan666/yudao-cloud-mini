...
public class WechatEnterpriseSocialAuthRequestBuilder implements SocialAuthRequestBuilder {
    ...
    public SocialAuthRequest build(SocialAuthClientConfig config) {
        return new WechatEnterpriseSocialAuthRequest(config, httpClient, stateCache);
    }
